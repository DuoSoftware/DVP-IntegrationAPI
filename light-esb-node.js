...
var ESBCallComponent = function(callback, requestURL, method, pathArguments, queryParameters, authProperties, requestProperties){
    ...
    ESBComponent.call(this,function(context,message){
        ...
        if(authProperties && authProperties.auth_type && authProperties.auth_type == "Basic"){
            options.user = authProperties.user;
            options.password = authProperties.password;
        }else if(authProperties && authProperties.auth_type && authProperties.auth_type == "Bearer"){
